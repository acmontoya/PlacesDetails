package example.com.placesapisample;
...
public class MainActivity extends AppCompatActivity implements
    ...
    // A default location (Philippines) and default zoom to use when location permission is
    // not granted.
    private final LatLng mDefaultLocation = new LatLng(12.8797, 121.7740);
            ...
            result.setResultCallback(new ResultCallback<PlaceLikelihoodBuffer>() {
                ...
                public void onResult(@NonNull PlaceLikelihoodBuffer likelyPlaces) {
                    for (PlaceLikelihood placeLikelihood : likelyPlaces) {
                        ...
                        String snippet = (String) placeLikelihood.getPlace().getPhoneNumber();
